...
# Install OpenJDK 15 on Linux
# This script is based on https://github.com/bisq-network/bisq/blob/master/scripts/install_java_linux.sh
...
JAVA_HOME_DIR=/usr/lib/jvm/openjdk-15

alpine_openjdk_package=openjdk15
alpine_openjdk_location=/usr/lib/jvm/java-15-openjdk
